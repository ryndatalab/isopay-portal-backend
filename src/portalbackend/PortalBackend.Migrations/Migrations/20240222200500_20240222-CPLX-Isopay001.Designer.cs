...
namespace Org.Eclipse.TractusX.Portal.Backend.PortalBackend.Migrations.Migrations
{
    ...
    [Migration("20240222200500_20240222-CPLX-Isopay001")]
    partial class _20240222CPLXIsopay001
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Org.Eclipse.TractusX.Portal.Backend.PortalBackend.PortalEntities.Entities.CompanySsiDetail", b =>
                {
                    ...
                    b.ToTable("company_ssi_details", "portal", t =>
                        {
            ...
            modelBuilder.Entity("PortalBackend.PortalEntities.EntitiesIsoPay.Account", b =>
                {
                    ...
                    b.HasIndex("AccountHeadId")
                        .HasDatabaseName("ix_account_account_head_id");

                    b.HasIndex("CurrencyId")
                        .HasDatabaseName("ix_account_currency_id");

                    b.ToTable("account", "portal");
                });
            ...
            modelBuilder.Entity("PortalBackend.PortalEntities.EntitiesIsoPay.AccountHead", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_account_head");

                    b.ToTable("account_head", "portal");
                });
            ...
            modelBuilder.Entity("PortalBackend.PortalEntities.EntitiesIsoPay.Transaction", b =>
                {
                    ...
                    b.Property<Guid>("AccCreditId")
                        .HasColumnType("uuid")
                        .HasColumnName("acc_credit_id");

                    b.Property<Guid>("AccDebitId")
                        .HasColumnType("uuid")
                        .HasColumnName("acc_debit_id");
                    ...
                    b.HasIndex("AccCreditId")
                        .HasDatabaseName("ix_transaction_acc_credit_id");

                    b.HasIndex("AccDebitId")
                        .HasDatabaseName("ix_transaction_acc_debit_id");

                    b.HasIndex("CurrencyId")
                        .HasDatabaseName("ix_transaction_currency_id");

                    b.HasIndex("TransactionTypeId")
                        .HasDatabaseName("ix_transaction_transaction_type_id");

                    b.ToTable("transaction", "portal");
                });
            ...
            modelBuilder.Entity("PortalBackend.PortalEntities.EntitiesIsoPay.TransactionType", b =>
                {
                    ...
                    b.ToTable("transaction_types", "portal");
                });
            ...
            modelBuilder.Entity("PortalBackend.PortalEntities.EntitiesIsoPay.Account", b =>
                {
                    b.HasOne("PortalBackend.PortalEntities.EntitiesIsoPay.AccountHead", "AccountHead")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_account_account_head_account_head_id");

                    b.HasOne("PortalBackend.PortalEntities.EntitiesIsoPay.Currency", "Currency")
                        .WithMany()
            ...
            modelBuilder.Entity("PortalBackend.PortalEntities.EntitiesIsoPay.Transaction", b =>
                {
                    b.HasOne("PortalBackend.PortalEntities.EntitiesIsoPay.Account", "AccCredit")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_transaction_account_acc_credit_id");
                    ...
                    b.HasOne("PortalBackend.PortalEntities.EntitiesIsoPay.Account", "AccDebit")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_transaction_account_acc_debit_id");
                    ...
                    b.HasOne("PortalBackend.PortalEntities.EntitiesIsoPay.TransactionType", "TransactionType")
                        .WithMany()
                        .HasForeignKey("TransactionTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_transaction_transaction_types_transaction_type_id");
